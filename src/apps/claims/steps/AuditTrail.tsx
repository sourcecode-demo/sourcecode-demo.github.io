...
import { claimAuditTrail } from '../../../data/claimsMock';
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Chronological log of claim processing events.</p>
      </div>

      <div className="bg-white border border-gray-200 rounded-lg p-6 mb-8">
        <div className="space-y-4">
          {claimAuditTrail.map((item, index) => (
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 mb-8">
        <div className="flex items-center space-x-2 text-purple-700 font-semibold mb-2">
          ...
          <span>End-to-end completion: 87 seconds</span>
        </div>
        <p className="text-sm text-purple-700">
          Audit events are mocked for demonstration only.
        </p>
      </div>
